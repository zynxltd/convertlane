            ...
            <div class="glass rounded-2xl p-8">
                ...
                <div class="mt-5 space-y-4 text-sm text-muted">
                    ...
                    <ol class="mt-4 list-inside list-decimal space-y-2">
                        <li>We’ll request your KYB/KYC document pack (usually within 2 business days).</li>
                        <li>Once checks are complete, your account is approved and you can access the dashboard.</li>
                        <li>If anything is missing, we’ll reply with exactly what we need to proceed.</li>
                    </ol>
